 ...
 */
package org.cafienne.service.http.userregistration.tenant.route
...
import org.cafienne.service.http.userregistration.tenant.model.TenantAPI.TenantUserResponseFormat
...
@Path("/tenant")
class TenantUsersRoute(override val httpService: CaseEngineHttpServer) extends TenantRoute {
