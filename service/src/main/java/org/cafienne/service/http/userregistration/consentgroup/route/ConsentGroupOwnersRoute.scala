...
package org.cafienne.service.http.userregistration.consentgroup.route
...
import org.cafienne.service.http.userregistration.consentgroup.model.ConsentGroupAPI._
import org.cafienne.usermanagement.consentgroup.actorapi.command.{RemoveConsentGroupMember, ReplaceConsentGroup, SetConsentGroupMember}
