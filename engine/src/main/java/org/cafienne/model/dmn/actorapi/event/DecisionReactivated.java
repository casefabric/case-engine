...
import org.cafienne.model.dmn.actorapi.command.ReactivateDecision;
...
@Manifest
public class DecisionReactivated extends BaseDecisionEvent {
    public final ValueMap inputParameters;

    public DecisionReactivated(DecisionTaskActor actor, ReactivateDecision command) {
        super(actor);
        this.inputParameters = command.getInputParameters();
    }

    public DecisionReactivated(ValueMap json) {
        super(json);
