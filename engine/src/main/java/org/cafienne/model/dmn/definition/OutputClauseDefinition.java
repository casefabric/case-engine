...
public class OutputClauseDefinition extends DMNElementDefinition {
    String typeRef;

    public OutputClauseDefinition(Element element, ModelDefinition modelDefinition, CMMNElementDefinition parentElement) {
    ...
    public boolean sameClause(OutputClauseDefinition other) {
