 ...
 */
@Manifest
public class DecisionModified extends ActorModified<DecisionTaskActor, CaseUserIdentity> implements DecisionEvent {

    public DecisionModified(DecisionTaskActor actor, ModelCommand source) {
        super(actor, source);
    }

    public DecisionModified(ValueMap json) {
        super(json);
    }
