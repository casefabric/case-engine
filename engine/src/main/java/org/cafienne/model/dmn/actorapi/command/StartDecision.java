...
@Manifest
public class StartDecision extends DecisionCommand implements BootstrapMessage {
    private final String parentActorId;
    private final String rootActorId;
    private final String tenant;
    private final String name;
    private final ValueMap inputParameters;
    private final DecisionModelDefinition definition;
    private final boolean debugMode;

    public StartDecision(CaseUserIdentity user, String tenant, String id, String name, DecisionModelDefinition definition, ValueMap inputParameters, String parentActorId, String rootActorId, boolean debugMode) {
        super(user, id);
        this.name = name;
        this.tenant = tenant;
    ...
    public StartDecision(ValueMap json) {
        super(json);
        ...
        this.definition = json.readDefinition(Fields.decisionDefinition, DecisionModelDefinition.class);
    ...
    public void write(JsonGenerator generator) throws IOException {
        ...
        writeField(generator, Fields.decisionDefinition, definition);
    }
}
