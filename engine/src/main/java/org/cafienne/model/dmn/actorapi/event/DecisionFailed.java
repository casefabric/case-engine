...
@Manifest
public class DecisionFailed extends DecisionEnded {
    public DecisionFailed(DecisionTaskActor actor, ValueMap outputParameters) {
        super(actor, outputParameters);
    }

    public DecisionFailed(ValueMap json) {
        super(json);
    }
