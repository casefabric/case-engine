...
@Manifest
public class DecisionCompleted extends DecisionEnded {
    public DecisionCompleted(DecisionTaskActor actor, ValueMap outputParameters) {
        super(actor, outputParameters);
    }

    public DecisionCompleted(ValueMap json) {
        super(json);
    }
