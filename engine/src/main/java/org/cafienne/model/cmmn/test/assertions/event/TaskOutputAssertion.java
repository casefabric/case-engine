...
package org.cafienne.model.cmmn.test.assertions.event;
...
public class TaskOutputAssertion extends CaseInstanceEventAssertion<TaskOutputFilled> {
    ...
    public TaskOutputAssertion assertValue(String outputParameterName, Object expectedValue) {
        ...
        if (expectedValue == null) {
            ...
            throw new AssertionError("Task output parameter " + outputParameterName + " does not contain the expected value " + expectedValue + ", but " + value);
        }
        return this;
    }
