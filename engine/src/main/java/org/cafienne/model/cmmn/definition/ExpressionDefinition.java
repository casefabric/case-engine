...
import org.cafienne.model.cmmn.expression.DefaultValueEvaluator;
 ...
 * convention "org.cafienne.model.cmmn.expression.[language]". The constructor of the ExpressionEvaluator class must take {@link ExpressionDefinition} as an argument. Examples:
 * <ul>
 * <li>ExpressionEvaluator</li>
 * <li>org.cafienne.model.cmmn.expression.xpath.ExpresionEvaluator</li>
 * <li>ExpressionEvaluator</li>
 * </ul>
 */
public class ExpressionDefinition extends CMMNElementDefinition {
    ...
    private CMMNExpressionEvaluator instantiateEvaluator() {
        String evaluatorClassName = "org.cafienne.model.cmmn.expression." + language + ".ExpressionEvaluator";
        try {
