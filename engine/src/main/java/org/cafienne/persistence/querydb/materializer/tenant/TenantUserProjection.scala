...
import org.cafienne.persistence.querydb.record.userregistration.{UserRoleKey, UserRoleRecord}
import org.cafienne.usermanagement.tenant.actorapi.event.deprecated._
import org.cafienne.usermanagement.tenant.actorapi.event.user.{TenantMemberEvent, TenantUserAdded, TenantUserChanged, TenantUserRemoved}
