...
import org.cafienne.usermanagement.consentgroup.actorapi.event.{ConsentGroupMemberAdded, ConsentGroupMemberChanged, ConsentGroupMemberEvent, ConsentGroupMemberRemoved}
