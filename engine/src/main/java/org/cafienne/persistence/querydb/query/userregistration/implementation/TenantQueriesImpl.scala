package org.cafienne.persistence.querydb.query.userregistration.implementation
...
import org.cafienne.persistence.querydb.record.userregistration.{TenantRecord, UserRoleRecord}
