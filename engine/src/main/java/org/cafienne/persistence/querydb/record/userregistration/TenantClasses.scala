...
package org.cafienne.persistence.querydb.record.userregistration

import org.cafienne.usermanagement.tenant.actorapi.event.deprecated.{DeprecatedTenantUserEvent, TenantUserRoleEvent}
