...
public class ResponseDefinition extends ProcessInputResolver {
    public ResponseDefinition(Element element, ModelDefinition modelDefinition, CMMNElementDefinition parentElement) {
